...
class PlacePulse:
    ...
    def localize_point(self, lat, lon):
        """Returns: (continent, country, city) for a single lat/lon pair"""
        point = Point(lon, lat)  
        
        for continent_obj in self.country_city_dataset:
            # FIX: Convert [lat,lon] to [lon,lat]
            cont_coords = [[c[1], c[0]] for c in continent_obj["gps"]]
            pol_cont = Polygon(cont_coords)
            
            if point.within(pol_cont):
                for city_country in continent_obj['cities']:
                    city_coords = [[c[1], c[0]] for c in city_country["gps"]]
                    pol_count = Polygon(city_coords)
                    
                    if point.within(pol_count):
                        return (continent_obj['continent'],
                           ...
                           "cities":[
                              {
                                "country": "Austria",
                                "city": "Linz",
                                "gps": [[48.3892996, 14.1789316],
                                        [48.3923707, 14.3941478],
                                        [48.1947667, 14.4582830],
                                        [48.1959954, 14.2120737]]
                              }, 
                              {
                                "country": "Austria",
                                "city": "Salzburg",
                                "gps": [[47.8680348, 12.9384278],
                                        [47.8725294, 13.1488531],
                                        [47.7424435, 13.1504726],
                                        [47.7407381, 12.9474317]]
                              },
                              {
                              "country": "Russia",
                              "city": "Moscow",
